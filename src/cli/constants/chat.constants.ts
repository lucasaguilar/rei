...
export const SHORTCUT_HINT = "Shortcuts: Up/Down history (at bottom) | Ctrl+U/D scroll | / commands | @ files | Tab complete | Esc close | Ctrl+R search";
export const MOUSE_SCROLL_STEP = 3;

export const COMMANDS: Array<{ command: string; description: string; requiresArgs?: boolean }> = [
